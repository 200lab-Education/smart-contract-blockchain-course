...
contract DragonKartNFTMarketplace is AccessControlEnumerable {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    constructor(
        ...
        require(
            ...
            "DragonKartNFTMarketplace: nftAddress_ is zero address"
        );
        require(
            feeRecipient_ != address(0),
            "DragonKartNFTMarketplace: feeRecipient_ is zero address"
        );
    ...
    modifier onlySupportedPaymentToken(address paymentToken_) {
        require(
            ...
            "DragonKartNFTMarketplace: unsupport payment token"
        );
        _;
    }
    ...
    modifier onlyOnSaleOrder(uint256 orderId_) {
        require(
            ...
            "DragonKartNFTMarketplace: order is not on sale"
        );
        _;
    }
    ...
    modifier canMatch(
        ...
        require(
            ...
            "DragonKartNFTMarketplace: buyer must be different from seller"
        );
        require(
            price_ == orders[orderId_].price,
            "DragonKartNFTMarketplace: price has been changed"
        );
        _;
    }
    ...
    function _updateFeeRate(uint256 feeDecimal_, uint256 feeRate_) internal {
        require(
            ...
            "DragonKartNFTMarketplace: bad fee rate"
        );
    ...
    function updateFeeRecipient(address feeRecipient_)
        external
    ...
    function addPaymentToken(address paymentToken_)
        external
        onlyRole(MAINTAINER_ROLE)
    {
        require(
        ...
        require(
            ...
            "DragonKartNFTMarketplace: already supported"
        );
    }
    ...
    function addOrder(
        ...
        require(
            ...
            "DragonKartNFTMarketplace: sender is not owner of token"
        );
        require(
            nftCore.getApproved(tokenId_) == address(this) ||
                nftCore.isApprovedForAll(_msgSender(), address(this)),
            "DragonKartNFTMarketplace: The contract is unauthorized to manage this token"
        );
        require(
            price_ > 0,
            "DragonKartNFTMarketplace: price must be greater than 0"
        );
